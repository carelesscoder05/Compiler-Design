...
#line 65 "parser.y"
    {
        assignVar((yyvsp[-3].str), (yyvsp[-1].nodeId));
    }
#line 1109 "parser.tab.c"
  ...
  case 5: /* E: NUM  */
#line 71 "parser.y"
        { (yyval.nodeId) = makeConstNode((yyvsp[0].num)); }
#line 1115 "parser.tab.c"
    break;

  case 6: /* E: ID  */
#line 72 "parser.y"
         { (yyval.nodeId) = getVarNode((yyvsp[0].str)); }
#line 1121 "parser.tab.c"
    break;

  case 7: /* E: E PLUS E  */
#line 73 "parser.y"
               { (yyval.nodeId) = makeOpNode('+', (yyvsp[-2].nodeId), (yyvsp[0].nodeId)); }
