...
#line 30 "simple.y"
            { char* r
= new_reg();
emit("MOV", r, (yyvsp[-2].str));
emit("ADD", r, (yyvsp[0].str));
(yyval.str) = r;
}
#line 1094 "simple.tab.c"
    break;
...
#line 1130 "simple.tab.c"
    break;

  case 7: /* E: '(' E ')'  */
#line 57 "simple.y"
            { (yyval.str) = (yyvsp[-1].str); }
#line 1136 "simple.tab.c"
    break;
